...
<head>
    ...
    <link href="<?= base_url('assets/startbootstrap2/')?>vendor/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css">
    <link
                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 border border-left-1">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Login</h1>
                                    </div>

                                    <form class="user" action="<?= base_url('/AuthController/auth'); ?>" method="POST">
                                    ...
                                    <hr>
									<div class="text-center">
                                        <p>Copyright &copy; Badan Perencanaan Pembangunan Daerah Provinsi Papua Barat 2021</p>
                                    </div>
                                </div>
                            </div>
                        </div>
